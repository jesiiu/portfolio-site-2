...
.icon {
  ...
  margin: 2rem;
  &#vue {
    box-shadow: 0px 0px 25px 2px #0dd459;
  }
  &#scss {
    box-shadow: 0px 0px 25px 2px #ff149d;
  }
  &#js {
    box-shadow:
      2px -2px 15px 2px rgb(17, 0, 255),
  ...
  &#pgsql {
    box-shadow: 0px 0px 25px 2px #0746ce;
  }
  &#nginx {
    box-shadow: 0px 0px 25px 2px #2daf05;
  }
  &#apache {
